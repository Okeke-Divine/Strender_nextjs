    ...
    <>
      <main className="mainComponent text-white">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Strender.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Strender, accessible from <a href="https://strender.vercel.app/" rel="external nofollow noopener" target="_blank">https://strender.vercel.app/</a></p>
          </li>
          <li>
        ...
        <h4 className="text-lg">Information from Third-Party Social Media Services</h4>
        ...
        <ul>
          <li>By email: okekedivine.skiy1@gmail.com</li>
        </ul>
      </main>
    </>
  )
